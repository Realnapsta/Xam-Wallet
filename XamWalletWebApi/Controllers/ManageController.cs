...
using XamWalletWebApi.API.Settings;
using XamWalletWebApi.Models;
using XamWalletWebApi.Models.ViewModels;
using XamWalletWebApi.Services;
using XamWalletWebApi.Settings;
using XamWalletWebApi.ViewModels;

namespace XamWalletWebApi.Controllers
{
    [Authorize]
